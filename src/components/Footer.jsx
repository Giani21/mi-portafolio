...
import { FaGithub, FaLinkedin, FaEnvelope, FaTerminal, FaCode, FaHeart } from 'react-icons/fa';
  ...
  return (
    <footer className="relative bg-[#050505] pt-20 pb-10 overflow-hidden border-t border-white/5">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute -top-[100px] left-1/4 w-[500px] h-[500px] bg-cyan-500/5 blur-[120px] rounded-full mix-blend-screen" />
      </div>

      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
          
          {/* COLUMNA 1: IDENTIDAD (4 columnas) */}
          <div className="md:col-span-5 space-y-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-zinc-500 text-[10px] font-mono tracking-widest">FULL_STACK_DEV // OPERATOR</p>
              </div>
            </div>
          ...
          <div className="md:col-span-3">
            <h4 className="text-white font-bold mb-6 flex items-center gap-2">
              <span className="w-1 h-4 bg-cyan-500 rounded-sm" />
              ...
              {['home', 'stack', 'projects'].map((item) => (
                <li key={item}>
                  <button 
                    ...
                    className="text-zinc-400 hover:text-cyan-400 hover:translate-x-2 transition-all duration-300 flex items-center gap-2 text-sm group"
                  >
...
const SocialButton = ({ href, icon: Icon, label }) => (
  <a 
    ...
    className="group relative flex items-center justify-center w-12 h-12 bg-zinc-900 border border-zinc-800 hover:border-cyan-500/50 hover:bg-cyan-500/10 transition-all duration-300 rounded-sm overflow-hidden"
    aria-label={label}
  >
    <Icon className="text-zinc-400 group-hover:text-cyan-400 text-xl relative z-10 transition-transform group-hover:scale-110" />
